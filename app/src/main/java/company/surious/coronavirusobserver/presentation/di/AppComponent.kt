...
import company.surious.coronavirusobserver.device.network.DeviceModule
...
@Component(
    modules = [AndroidInjectionModule::class, AppModule::class, RepositoriesModule::class,
        ActivityModule::class, FragmentModule::class, ServiceModule::class, DeviceModule::class,
